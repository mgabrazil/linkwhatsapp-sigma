...
export function ContainerMain({ grupos }: { grupos: GrupoUnidade[] }) {
  return (
    <div className="relative">
      ...
      <p className="absolute top-[17%] right-[18%] left-[50%] text-right text-[18px] leading-snug font-semibold text-white/90 sm:text-[20px] lg:inset-x-0 lg:top-[7%] lg:text-center">
